...
<link rel="canonical" href="../collections/GertrudeBassWarnerCollectionofJapaneseVotiveSlipsnsatsu1850sto1930s.php">
<?php include("../includes/ampstyle.php");?>
 
<!-- Collection Title -->
<h3>Gertrude Bass Warner Collection of Japanese Votive Slips (n_satsu), 1850s to 1930s</h3>
...
<amp-img src="../images/collection_images/collection2492.jpg"alt="Two unit exchange votive slip with double-line border: first/early Autumn scene with three [dogs] playing beneath green-leafed, snow-laden branches"width="250" height ="250"  layout = "responsive"></amp-img>
</div>
<!-- Image Description -->
