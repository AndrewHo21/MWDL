...
<link rel="canonical" href="../collections/JamesCloutierCollection.php">
<?php include("../includes/ampstyle.php");?>
 
<!-- Collection Title -->
<h3>James Cloutier Collection</h3>
<!-- Collection Publisher -->
<h6> Published by <a href="../partners/UniversityofOregonLibraries.php">University of Oregon Libraries</a></h6>
<!-- Collection Image -->
<div class=amp-img-fill>
<amp-img src="../images/collection_images/collection2261.jpg"alt="Two women visit inside the Alpine Tavern."width="250" height ="250"  layout = "responsive"></amp-img>
</div>
<!-- Image Description -->
