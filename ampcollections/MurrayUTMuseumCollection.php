...
<link rel="canonical" href="../collections/MurrayUTMuseumCollection.php">
<?php include("../includes/ampstyle.php");?>
 
<!-- Collection Title -->
<h3>Murray (UT) Museum Collection</h3>
<!-- Collection Publisher -->
<h6> Published by <a href="../partners/MurrayUTMuseum.php">Murray (UT) Museum</a></h6>
<!-- Collection Image -->
<div class=amp-img-fill>
<amp-img src="../images/collection_images/collection1543.jpg"alt="1910 Car"width="379" height ="232"  layout = "responsive"></amp-img>
</div>
<!-- Image Description -->
1910 Car
<!-- Article Text -->
