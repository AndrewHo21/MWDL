...
<link rel="canonical" href="../collections/NorthwestChristianUniversity.php">
<?php include("../includes/ampstyle.php");?>
 
<!-- Collection Title -->
<h3>Northwest Christian University</h3>
<!-- Collection Publisher -->
<h6> Published by <a href="../partners/NorthwestChristianUniversity.php">Northwest Christian University</a></h6>
<!-- Collection Image -->
<div class=amp-img-fill>
<amp-img src="../images/collection_images/collection2521.jpg"alt="Typewritten pages recounting the life of James A. Bushnell, first chair of the Eugene (Oregon) Divinity School Board of Regents, between 1844 and April 2, 1910. With handwritten notes by Maud Skaggs Woodyard."width="250" height ="250"  layout = "responsive"></amp-img>
</div>
<!-- Image Description -->
