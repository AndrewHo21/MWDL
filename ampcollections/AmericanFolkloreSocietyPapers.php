...
<link rel="canonical" href="../collections/AmericanFolkloreSocietyPapers.php">
<?php include("../includes/ampstyle.php");?>
 
<!-- Collection Title -->
<h3>American Folklore Society Papers</h3>
<!-- Collection Publisher -->
<h6> Published by <a href="../partners/UtahStateUniversityMerrillCazierLibrary.php">Utah State University - Merrill-Cazier Library</a></h6>
<!-- Collection Image -->
<div class=amp-img-fill>
<amp-img src="../images/collection_images/collection2422.jpg"alt="American Folklore Society Papers"width="250" height ="250"  layout = "responsive"></amp-img>
</div>
<!-- Image Description -->
