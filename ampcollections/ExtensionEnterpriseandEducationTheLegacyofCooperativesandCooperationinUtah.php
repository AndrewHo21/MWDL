...
<link rel="canonical" href="../collections/ExtensionEnterpriseandEducationTheLegacyofCooperativesandCooperationinUtah.php">
<?php include("../includes/ampstyle.php");?>
 
<!-- Collection Title -->
<h3>Extension, Enterprise and Education: The Legacy of Cooperatives and Cooperation in Utah</h3>
<!-- Collection Publisher -->
<h6> Published by <a href="../partners/UtahStateUniversityMerrillCazierLibrary.php">Utah State University - Merrill-Cazier Library</a></h6>
<!-- Collection Image -->
<div class=amp-img-fill>
<amp-img src="../images/collection_images/collection1550.jpg"alt="Postcard of Sunstone from Mormon Temple, Nauvoo, Illinois"width="363" height ="321"  layout = "responsive"></amp-img>
</div>
<!-- Image Description -->
Postcard of Sunstone from Mormon Temple, Nauvoo, Illinois
<!-- Article Text -->
</p><br/>Co-operatives are voluntary associations jointly-owned and operated for the benefit of those using their services. While the Co-operative Movement was a worldwide phenomena in the 1800s, it was particularly strong and pervasive early on in Utah. Nineteenth-century Utah pioneers embraced the spirit of cooperation, building shared irrigation systems and establishing co-op stores within their communities.</p><br/>
<hr>
<!-- Browse Collection -->
<h6>
