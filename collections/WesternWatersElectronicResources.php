...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/WesternWatersElectronicResources.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/WesternWatersElectronicResources.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/WesternWatersElectronicResources.php">
<!-- Collection #1044 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/WesternWatersElectronicResources.php&t=Western Waters: Electronic Resources"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/WesternWatersElectronicResources.php&via=@MountainWestDL&text=Western Waters: Electronic Resources"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/WesternWatersElectronicResources.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection1044.jpg" alt="Water Quality in South-Central Texas"width="375" height="484"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
Water Quality in South-Central Texas
</div>
<!-- Collection Title-->
<h4>Western Waters: Electronic Resources</h4>
...
<h6>
<!-- Browse Link -->
<a href="https://utah-primoprod.hosted.exlibrisgroup.com/primo-explore/search?query=lsr04,exact1044&tab=default_tab&search_scope=mw&vid=MWDL&offset=0">Browse all record in Western Waters: Electronic Resources</a>
</h6>
<p></p>
</div>
</div>
