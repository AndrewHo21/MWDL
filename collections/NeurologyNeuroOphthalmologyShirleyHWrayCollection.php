...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/NeurologyNeuroOphthalmologyShirleyHWrayCollection.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/NeurologyNeuroOphthalmologyShirleyHWrayCollection.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/NeurologyNeuroOphthalmologyShirleyHWrayCollection.php">
<!-- Collection #1049 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/NeurologyNeuroOphthalmologyShirleyHWrayCollection.php&t=Neurology/Neuro-Ophthalmology: Shirley H. Wray Collection"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/NeurologyNeuroOphthalmologyShirleyHWrayCollection.php&via=@MountainWestDL&text=Neurology/Neuro-Ophthalmology: Shirley H. Wray Collection"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/NeurologyNeuroOphthalmologyShirleyHWrayCollection.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection1049.jpg" alt="MS Time Lapse MRI"width="258" height="192"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
MS Time Lapse MRI
</div>
<!-- Collection Title-->
<h4>Neurology/Neuro-Ophthalmology: Shirley H. Wray Collection</h4>
