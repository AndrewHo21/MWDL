...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/NeuroOphthalmologyWilliamFHoytCollection.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/NeuroOphthalmologyWilliamFHoytCollection.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/NeuroOphthalmologyWilliamFHoytCollection.php">
<!-- Collection #1008 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/NeuroOphthalmologyWilliamFHoytCollection.php&t=Neuro-Ophthalmology: William F. Hoyt Collection"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/NeuroOphthalmologyWilliamFHoytCollection.php&via=@MountainWestDL&text=Neuro-Ophthalmology: William F. Hoyt Collection"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/NeuroOphthalmologyWilliamFHoytCollection.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection1008.jpg" alt="Buried drusen"width="212" height="210"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
Buried drusen
</div>
<!-- Collection Title-->
<h4>Neuro-Ophthalmology: William F. Hoyt Collection</h4>
