...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/WesternWatersTreatiesandCompacts.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/WesternWatersTreatiesandCompacts.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/WesternWatersTreatiesandCompacts.php">
<!-- Collection #1045 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/WesternWatersTreatiesandCompacts.php&t=Western Waters: Treaties and Compacts"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/WesternWatersTreatiesandCompacts.php&via=@MountainWestDL&text=Western Waters: Treaties and Compacts"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/WesternWatersTreatiesandCompacts.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection1045.jpg" alt="Interstate Compacts: A Compilation of Articles from Various Sources"width="270" height="360"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
Interstate Compacts: A Compilation of Articles from Various Sources
</div>
<!-- Collection Title-->
<h4>Western Waters: Treaties and Compacts</h4>
...
<h6>
<!-- Browse Link -->
<a href="https://utah-primoprod.hosted.exlibrisgroup.com/primo-explore/search?query=lsr04,exact1045&tab=default_tab&search_scope=mw&vid=MWDL&offset=0">Browse all record in Western Waters: Treaties and Compacts</a>
</h6>
<p></p>
</div>
</div>
