...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/MS034SchuylerHartleyandGraham.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/MS034SchuylerHartleyandGraham.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/MS034SchuylerHartleyandGraham.php">
<!-- Collection #2275 -->
<!-- Collection Title -->
<title>MS 034 Schuyler, Hartley, and Graham</title>
<?php include("../includes/collectionmenuhead.php");?>
 
<!-- Share Links -->
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/MS034SchuylerHartleyandGraham.php&t=MS 034 Schuyler, Hartley, and Graham"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/MS034SchuylerHartleyandGraham.php&via=@MountainWestDL&text=MS 034 Schuyler, Hartley, and Graham"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/MS034SchuylerHartleyandGraham.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection2275.jpg" alt="<em>Correspondence - from Schuyler, Hartley & Graham Box 25, Folder 46</em>"width="409" height="250"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
<em>Correspondence - from Schuyler, Hartley & Graham Box 25, Folder 46</em>
</div>
<!-- Collection Title-->
...
<h6>
<!-- Browse Link -->
<a href="https://utah-primoprod.hosted.exlibrisgroup.com/primo-explore/search?query=lsr04,exact2275&tab=default_tab&search_scope=mw&vid=MWDL&offset=0">Browse all record in MS 034 Schuyler, Hartley, and Graham</a>
</h6>
<p></p>
</div>
</div>
