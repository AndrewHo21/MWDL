...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/DorisUlmannPhotographs.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/DorisUlmannPhotographs.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/DorisUlmannPhotographs.php">
<!-- Collection #2253 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/DorisUlmannPhotographs.php&t=Doris Ulmann Photographs"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/DorisUlmannPhotographs.php&via=@MountainWestDL&text=Doris Ulmann Photographs"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/DorisUlmannPhotographs.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection2253.jpg" alt="Jane Chase, spinner and weaver, at the loom"width="250" height="250"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
Jane Chase, spinner and weaver, at the loom
</div>
<!-- Collection Title-->
<h4>Doris Ulmann Photographs</h4>
...
<h6>
<!-- Browse Link -->
<a href="https://utah-primoprod.hosted.exlibrisgroup.com/primo-explore/search?query=lsr04,exact2253&tab=default_tab&search_scope=mw&vid=MWDL&offset=0">Browse all record in Doris Ulmann Photographs</a>
</h6>
<p></p>
</div>
</div>
