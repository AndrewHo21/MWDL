...
<meta name="description" content="Building Oregon, a MWDL collection, presented by University of Oregon Libraries">
<?php include ("../includes/collectionlinkimports.php");?>
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/BuildingOregon.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/BuildingOregon.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/BuildingOregon.php">
<!-- Collection #2497 -->
<!-- Collection Title -->
<title>Building Oregon</title>
<?php include("../includes/collectionmenuhead.php");?>
 
<!-- Share Links -->
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/BuildingOregon.php&t=Building Oregon"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/BuildingOregon.php&via=@MountainWestDL&text=Building Oregon"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/BuildingOregon.php"
...
<h6>
<!-- Browse Link -->
<a href="https://utah-primoprod.hosted.exlibrisgroup.com/primo-explore/search?query=lsr04,exact2497&tab=default_tab&search_scope=mw&vid=MWDL&offset=0">Browse all record in Building Oregon</a>
</h6>
<p></p>
</div>
</div>
