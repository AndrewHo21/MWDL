...
<meta name="description" content="Charles R. Savage Photographs 1, a MWDL collection, presented by Brigham Young University - Harold B. Lee Library">
<?php include ("../includes/collectionlinkimports.php");?>
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/CharlesRSavagePhotographs1.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/CharlesRSavagePhotographs1.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/CharlesRSavagePhotographs1.php">
<!-- Collection #1059 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/CharlesRSavagePhotographs1.php&t=Charles R. Savage Photographs 1"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/CharlesRSavagePhotographs1.php&via=@MountainWestDL&text=Charles R. Savage Photographs 1"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/CharlesRSavagePhotographs1.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection1059.jpg" alt="Charles R. Savage Photographs 2"width="342" height="290"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
Charles R. Savage Photographs 2
</div>
<!-- Collection Title-->
<h4>Charles R. Savage Photographs 1</h4>
