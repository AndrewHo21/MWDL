...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/MS017CharlesRappCollection.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/MS017CharlesRappCollection.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/MS017CharlesRappCollection.php">
<!-- Collection #2274 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/MS017CharlesRappCollection.php&t=MS 017 Charles Rapp Collection"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/MS017CharlesRappCollection.php&via=@MountainWestDL&text=MS 017 Charles Rapp Collection"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/MS017CharlesRappCollection.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection2274.jpg" alt="<em>Letter from Charles Rapp to Libbia Shepard</em>"width="409" height="250"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
...
<h6>
<!-- Browse Link -->
<a href="https://utah-primoprod.hosted.exlibrisgroup.com/primo-explore/search?query=lsr04,exact2274&tab=default_tab&search_scope=mw&vid=MWDL&offset=0">Browse all record in MS 017 Charles Rapp Collection</a>
</h6>
<p></p>
</div>
</div>
