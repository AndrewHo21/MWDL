...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/WilsonWSorensenCollectionofHistoricalPhotographsofUtahValleyUniversity.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/WilsonWSorensenCollectionofHistoricalPhotographsofUtahValleyUniversity.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/WilsonWSorensenCollectionofHistoricalPhotographsofUtahValleyUniversity.php">
<!-- Collection #1277 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/WilsonWSorensenCollectionofHistoricalPhotographsofUtahValleyUniversity.php&t=Wilson W. Sorensen Collection of Historical Photographs of Utah Valley University"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/WilsonWSorensenCollectionofHistoricalPhotographsofUtahValleyUniversity.php&via=@MountainWestDL&text=Wilson W. Sorensen Collection of Historical Photographs of Utah Valley University"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/WilsonWSorensenCollectionofHistoricalPhotographsofUtahValleyUniversity.php"
...
<h6>
<!-- Browse Link -->
<a href="https://utah-primoprod.hosted.exlibrisgroup.com/primo-explore/search?query=lsr04,exact1277&tab=default_tab&search_scope=mw&vid=MWDL&offset=0">Browse all record in Wilson W. Sorensen Collection of Historical Photographs of Utah Valley University</a>
</h6>
<p></p>
</div>
</div>
