...
<meta name="description" content="Lowenstam Collection of Ancient Western Art and Archaeology, a MWDL collection, presented by Department of Classics and the Department of the History of Art and Architecture, University of Oregon">
<?php include ("../includes/collectionlinkimports.php");?>
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/LowenstamCollectionofAncientWesternArtandArchaeology.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/LowenstamCollectionofAncientWesternArtandArchaeology.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/LowenstamCollectionofAncientWesternArtandArchaeology.php">
<!-- Collection #2519 -->
<!-- Collection Title -->
<title>Lowenstam Collection of Ancient Western Art and Archaeology</title>
<?php include("../includes/collectionmenuhead.php");?>
 
<!-- Share Links -->
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/LowenstamCollectionofAncientWesternArtandArchaeology.php&t=Lowenstam Collection of Ancient Western Art and Archaeology"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/LowenstamCollectionofAncientWesternArtandArchaeology.php&via=@MountainWestDL&text=Lowenstam Collection of Ancient Western Art and Archaeology"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/LowenstamCollectionofAncientWesternArtandArchaeology.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection2519.jpg" alt="Orestes at Delphi (Pottery: red-figured bell-krater (wine-bowl))"width="250" height="250"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
Orestes at Delphi (Pottery: red-figured bell-krater (wine-bowl))
</div>
<!-- Collection Title-->
<h4>Lowenstam Collection of Ancient Western Art and Archaeology</h4>
