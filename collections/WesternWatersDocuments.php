...
<meta name="description" content="Western Waters: Documents, a MWDL collection, presented by University of Utah - J. Willard Marriott Library">
<?php include ("../includes/collectionlinkimports.php");?>
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/WesternWatersDocuments.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/WesternWatersDocuments.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/WesternWatersDocuments.php">
<!-- Collection #1043 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/WesternWatersDocuments.php&t=Western Waters: Documents"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/WesternWatersDocuments.php&via=@MountainWestDL&text=Western Waters: Documents"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/WesternWatersDocuments.php"
...
<h6>
<!-- Browse Link -->
<a href="https://utah-primoprod.hosted.exlibrisgroup.com/primo-explore/search?query=lsr04,exact1043&tab=default_tab&search_scope=mw&vid=MWDL&offset=0">Browse all record in Western Waters: Documents</a>
</h6>
<p></p>
</div>
</div>
