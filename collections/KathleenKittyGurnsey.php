...
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/KathleenKittyGurnsey.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/KathleenKittyGurnsey.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="../ampcollections/KathleenKittyGurnsey.php">
<!-- Collection #2215 -->
<!-- Collection Title -->
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.facebook.com/sharer/sharer.php?u=mwdl.org/collections/KathleenKittyGurnsey.php&t=Kathleen (Kitty) Gurnsey"
                                  target="_blank"><img src="../images/facebook.png" alt="facebook"
                                                       height="20" width="20"> Facebook</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.twitter.com/intent/tweet?url=mwdl.org/collections/KathleenKittyGurnsey.php&via=@MountainWestDL&text=Kathleen (Kitty) Gurnsey"
                                  target="_blank"><img src="../images/twitter.png" alt="twitter"
                                                       height="20" width="20"> Twitter</a></li>
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/KathleenKittyGurnsey.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection2215.jpg" alt=""Idaho State Representative Kathleen ""Kitty"" Gurnsey, ca 1980""width="250" height="250"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
"Idaho State Representative Kathleen ""Kitty"" Gurnsey, ca 1980"
</div>
<!-- Collection Title-->
<h4>Kathleen (Kitty) Gurnsey</h4>
...
<h6>
<!-- Browse Link -->
<a href="https://utah-primoprod.hosted.exlibrisgroup.com/primo-explore/search?query=lsr04,exact2215&tab=default_tab&search_scope=mw&vid=MWDL&offset=0">Browse all record in Kathleen (Kitty) Gurnsey</a>
</h6>
<p></p>
</div>
</div>
