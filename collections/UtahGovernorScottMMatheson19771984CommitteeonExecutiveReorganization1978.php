...
<meta name="description" content="Utah Governor Scott M. Matheson (1977-1984). Committee on Executive Reorganization, 1978, a MWDL collection, presented by Utah State Archives">
<?php include ("../includes/collectionlinkimports.php");?>
<script type="text/javascript">
	if (screen.width <= 800) {
  		window.location = "../ampcollections/UtahGovernorScottMMatheson19771984CommitteeonExecutiveReorganization1978.php";
	}
</script>
<!-- Mobile Links -->
<link rel="amphtml" href="../ampcollections/UtahGovernorScottMMatheson19771984CommitteeonExecutiveReorganization1978.php">
...
<li class="mdl-menu__item"><a class="mdl-navigation__link"
                                  href="http://www.tumblr.com/share/link?url=mwdl.org/collections/UtahGovernorScottMMatheson19771984CommitteeonExecutiveReorganization1978.php"
...
<!-- Image (if any)-->
<img src="../images/collection_images/collection1626.jpg" alt="Committee Executive Summary"width="316" height="401"align= "right" style="max-width: 250px; height: auto; margin: 1%; display: block; ">
<!-- Image Description -->
...
</p><br/>This series contains correspondence, publications, and reports pertaining to state agencies that passed through the Governor's office. The topical focus of the materials created by the Governor online are the Committee on Executive Reorganization.</p><br/></p><br/>
<hr>
<h6>
<!-- Browse Link -->
